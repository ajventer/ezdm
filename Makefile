...
install: check
		...
		desktop-file-install --dir=${DESTDIR}/${PREFIX}/share/applications/ ezdm-web.desktop 
		...
		install -g root -o root -m 0666 ezdm-web.png ${DESTDIR}/${PREFIX}/share/icons/hicolor/128x128/ezdm-web.png 
